...
<body>
  <!-- START EXPORT LAPORAN MASUK -->
<div class="container">
    <h2>Stock Barang</h2>
    <h4>(Inventory)</h4>
      <div class="bg-white align-items-center justify-content-between">
          <h4 class="text-dark">Laporan Barang Masuk</h4>
